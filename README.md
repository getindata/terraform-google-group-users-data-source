...
| <a name="input_group_email"></a> [group\_email](#input\_group\_email) | (Required) The Group email under which to lookup the Membership names. | `string` | n/a | yes |
...
| <a name="input_parent"></a> [parent](#input\_parent) | (Required) The resource name of the entity under which this Group resides in the Cloud Identity resource hierarchy. Must be of the form identitysources/{identity\_source\_id} for external-identity-mapped groups or customers/{customer\_id} for Google Groups. | `string` | n/a | yes |
...
| [google_cloud_identity_groups.groups](https://registry.terraform.io/providers/hashicorp/google/latest/docs/data-sources/cloud_identity_groups) | data source |
<!-- END_TF_DOCS -->
