...
| <a name="input_group_email"></a> [group\_email](#input\_group\_email) | Group ID | `string` | `"example-group@google.com"` | no |
...
| <a name="input_parent"></a> [parent](#input\_parent) | Parent group ID | `string` | n/a | yes |
