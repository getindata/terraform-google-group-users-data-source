...
| <a name="input_group_email"></a> [group\_email](#input\_group\_email) | Group ID | `string` | `"snowflake-users@getindatas.com"` | no |
...
| <a name="input_parent"></a> [parent](#input\_parent) | Parent group ID | `string` | `"customers/C03qgsz5q"` | no |
